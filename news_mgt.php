            ...
            <div class="table-title">
                <div class="row">
                    <div class="d-flex justify-content-between">
                        <div class="col-sm-8"><h2>新聞管理</h2></div>
                        <a class="button" href="add_activity.html">新增新聞</a>
                    </div>
                </div>
            </div>
...
" 
<form action='show_revise_news.php' method='post'> 
<input type='hidden' value=".$row['name']." name='revise_name'>
<input type='submit' class='revise' title='revise' name='revise' value='修改'>
</form></td><td>
